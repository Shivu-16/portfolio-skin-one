...
function isInViewport() {
  ...
  return (
    e.top >= 0 &&
    e.left >= 0 &&
    e.bottom <= (window.innerHeight || n.clientHeight) &&
    e.right <= (window.innerWidth || n.clientWidth)
  );
}
window.addEventListener("scroll", function (t) {
  var e = document.querySelector(".js-block-img-container");
  isInViewport(), 1 == isInViewport() && e.classList.add("is-active");
});
function setViewBox() {
  bubblesHeader.setAttributeNS(
    null,
    "viewBox",
    "0 0 " + screenWidth + " " + screenHeight
  ),
    bubblesFooter.setAttributeNS(
      null,
      "viewBox",
      "0 0 " + screenWidth + " 100"
    );
...
function rearrangeCircles() {
  for (
    var e = bubblesHeader.querySelectorAll("circle"),
      t = bubblesFooter.querySelectorAll("circle"),
      r = 0;
    r < e.length;
    r++
  )
    positionCircle(e[r]), positionFooterCircle(t[r]);
}
